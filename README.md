...
- **智忆**：智能记忆捕捉、结构化提取、语义检索，沉淀为能力证据
- **智引**：SMART 目标拆解、生命之花平衡、动态调整、能力差距分析
- **今日行动**：任务打卡、进度追踪、AI 调整建议
- **生命之树**：可视化人生全景，树干为人生主题、根系为能力（由智忆证据支撑）、花果为目标
...
智忆与智引的可视化融合：
- **树干**: 人生主题/北极星，核心方向与取舍
- **根系**: 能力节点（由智忆证据支撑），扎根越深、能力越强
- **主枝**: 人生领域（健康/事业/家庭/财务/成长/社交/兴趣/自我实现）
- **枝叶**: 今日任务，能力训练的最小单元
- **花朵**: 进行中目标（智引规划层）
- **果实**: 已完成目标，成果沉淀回智忆、增强能力根系
- **交互式探索**: 点击节点查看详情与关联，支持筛选和聚焦
